...
static volatile unsigned int rampTotalStepsCount = 100;              // number of steps needed to reach end-position.
    ...
    LinearRampXYZ::increment.gripOpen      = (double)(LinearRampXYZ::rampOnce.rampCompletion * LinearRampXYZ::distances.gripOpen     /100.00);
      ...
      Serial.println("Angles (Spin, Tilt, Open) = ("+String(LinearRampXYZ::increment.gripSpinAngle) +", "+String(LinearRampXYZ::increment.gripTiltAngle)+", "+String(LinearRampXYZ::increment.gripOpen)+"), ");
