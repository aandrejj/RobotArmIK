...
//
//
// NEXT is https://github.com/roTechnic/InverseKinematicArm
...
char moves[] = "{\"list\":[{\"servoNumber\":1,\"positionFrom\":0,\"positionTo\":180,\"moveDelay\":0},{\"servoNumber\":2,\"positionFrom\":0,\"positionTo\":180,\"moveDelay\":0}]}";
...
void servoSweepJson(char moves[], String text ) {
  StaticJsonDocument<200> moves_doc;
 ...
 // Fetch values.
  ...
  //moves_doc["list"][0]["servoNumber"]

  int sizeOfMovesDoc =  sizeof(moves_doc);
  Serial.print("servoSweepJson sizeOfMovesDoc = ");
  Serial.println(sizeOfMovesDoc);

  int sizeOfList =  sizeof(moves_doc["list"]);
  Serial.print("servoSweepJson sizeOfList = ");
  Serial.println(sizeOfList);

  int sizeOfElement =  sizeof(moves_doc["list"][0]);
  Serial.print("servoSweepJson sizeOfElement = ");
  Serial.println(sizeOfElement);

  int arrLen = sizeof(sizeOfList) / sizeof(sizeOfElement);

  Serial.print("servoSweepJson arrLen = ");
  ...
  for (int i = 0; i <= arrLen; i++) {
    servoNumber =  moves_doc["list"][1]["servoNumber"];
    positionFrom = moves_doc["list"][1]["positionFrom"];
    positionTo =   moves_doc["list"][1]["positionTo"];
    moveDelay =    moves_doc["list"][1]["moveDelay"];
    ...
    Serial.println(positionFrom);
    
    Serial.print(", positionTo = ");
    Serial.println(positionTo);
