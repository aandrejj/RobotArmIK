...
char moves[] = "{\"servoNumber\":1,\"positionFrom\":0,\"positionTo\":180,\"moveDelay\":0}";
...
void servoSweepJson(char moves[], String text ) {
 ...
 // Fetch values.
  ...
  int servoNumber = moves_doc["servoNumber"];
  int positionFrom = moves_doc["positionFrom"];
  int positionTo = moves_doc["positionTo"];
  int moveDelay = moves_doc["moveDelay"];
  
  // Print values.
  Serial.println("servoSweepJson parse OK.");
