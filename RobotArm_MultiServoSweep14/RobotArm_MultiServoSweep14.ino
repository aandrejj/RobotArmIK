...
//ServoRamp servoRamp(servo01, servo02, servo03, servo04, servo05, servo06);
//RampServos rampServos(servo01, servo02, servo03, servo04, servo05, servo06);//(ServoRamp(servo01), ServoRamp(servo02), ServoRamp(servo03), ServoRamp(servo04), ServoRamp(servo05), ServoRamp(servo06));
